import { DealsFilters, ExpiringListing } from '@/features/public/deals';
import { getDealTypes, getExpiringSoon, getStores } from '@/services';
...
const Page = async (props: Props) => {
    ...
    const [dealListResponse, dealTypes, stores] = await Promise.all([
        getExpiringSoon(initialDealType, initialStore, pageNum),
        getDealTypes(),
        getStores(),
    ]);
