...
export async function generateMetadata() {
    return {
        title: 'Clothes and Fashion | SavesMoney',
        alternates: {
            canonical: `${SITE.url}/clothes-and-fashion`,
        },
    };
}
...
const Page = async ({ searchParams }: Props) => {
    ...
    const dealTypeId = '6956911f6a21d3976431d2a8,695699068ad0acfed51c27bc';
        ...
        <div className="container min-h-screen">
            <div className="px-3 pt-6 pb-10">
                ...
                <DealsListing
                    ...
                    dealTypeName={'Clothes and Fashion'}
                    dealTypeSlug={'clothes-and-fashion'}
                />
            </div>
        </div>
    );
