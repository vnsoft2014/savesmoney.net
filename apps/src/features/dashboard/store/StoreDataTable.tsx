    ...
    const columns = [
        {
            name: 'Image',
            cell: (row: Store) => (
                <img src={row.thumbnail || '/image.png'} alt="Store image" className="py-2 object-cover rounded" />
            ),
            width: '120px',
        },
        {
        ...
        },
        {
            ...
            cell: (row: Store) => (
                <div className="flex gap-2">
                    <button
                        onClick={() => router.push(`/dashboard/store/${row._id}`)}
