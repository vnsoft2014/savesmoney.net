...
const DealsFilters = ({ showTypeFilter, dealTypes, stores }: DealsFiltersProps) => {
    ...
    return (
        <div className="flex flex-col-reverse lg:flex-row items-center gap-3 lg:gap-0 mt-2 md:mt-0">
            ...
            {hasActiveFilters && (
                <div className="flex justify-end flex-wrap gap-2 mr-3">
                    {filters.dealType && (
                        <Badge
                            variant="secondary"
                            className="bg-orange-100 font-normal text-[13px] text-orange-600 hover:bg-orange-100 border-none px-3 py-1 gap-2 rounded-full"
                        >
